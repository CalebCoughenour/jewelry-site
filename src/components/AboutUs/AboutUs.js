...
import { AboutUsSec, AboutUsTitle, AboutUsWrapper, AboutUsText, AboutUsImg } from './AboutUs.elements';
import './AboutUs.css';
      ...
      <Container>
        <Row style={{ alignItems: 'center'}}>
          <Card style={{ background: '#897fb1f0', border: '1px solid black', borderRadius: '5px'}}>
            <AboutUsTitle src='images/about-us/alt-about-banner-2.webp' alt='' />
            <Col xs={true}>
              <AboutUsImg src='images/about-us/about-us-img.jpg' alt='A photo of a statue wearing a necklace with a large pendant' />
